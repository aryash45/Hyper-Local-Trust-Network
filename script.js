document.addEventListener('DOMContentLoaded', () => {
    ...
    const navigateTo = (page) => {
        ...
        const pageElement = document.getElementById(`${page === 'home' ? 'main-scroll-area' : page + '-page'}`);
        if (pageElement) {
        ...
        if (page === 'security') {
            ...
            if(scoreCircle) {
                ...
                scoreCircle.classList.remove('security-score-circle');
                void scoreCircle.offsetWidth; // Trigger reflow
                scoreCircle.classList.add('security-score-circle');
            }
        }
    ...
    const addEventListeners = () => {
        ...
        dom.communityContent.addEventListener('click', (e) => {
            ...
            if (toggleBtn) {
                const postCard = toggleBtn.closest('[data-id]');
    ...
    addEventListeners();
    loadContent();
    navigateTo('home'); // Ensure home is the default page
});